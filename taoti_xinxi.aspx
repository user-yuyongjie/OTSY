<%@ Page Language="C#" AutoEventWireup="true" CodeFile="taoti_xinxi.aspx.cs" Inherits="HouAdmin_taoti_xinxi" Theme="mytheme" %>
...
<body>
    ...
    <div align="center">
        &nbsp; &nbsp; &nbsp; &nbsp;
        <table style="background-image: url(../igm/在线考试后台1.jpg); width: 966px; height: 623px">
            <tr>
                <td colspan="3" style="height: 65px">
                    &nbsp;<br />
                </td>
                <td colspan="1" style="height: 65px">
                </td>
            </tr>
            <tr style="font-size: 12pt; color: #000000">
                <td rowspan="2" style="vertical-align: top; width: 357px; text-align: center">
                    &nbsp;</td>
                <td rowspan="2" style="vertical-align: top; width: 207px; text-align: left">
                            ...
                            <table width="550">
                                <tr>
                                    ...
                                    <td style="width: 120px; height: 21px">
                                        <asp:DropDownList ID="ddlQueName" runat="server" Font-Size="9pt" Width="107px">
                                    ...
                                    <td style="width: 1977px; height: 21px">
                                        <asp:LinkButton ID="lbAddQue" runat="server" Font-Size="9pt" Font-Underline="False"
                                            OnClick="LinkButton10_Click">［添加套题］</asp:LinkButton></td>
                                </tr>
                            </table>
                            <asp:GridView ID="gvQueInfo" runat="server" AllowPaging="True" AutoGenerateColumns="False" Font-Size="9pt" OnPageIndexChanging="GridView1_PageIndexChanging"
                                OnRowDataBound="GridView1_RowDataBound" OnRowDeleting="GridView1_RowDeleting"
                                PageSize="5" Width="590px" SkinID="gvSkin">
                                <Columns>
