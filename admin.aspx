    ...
    <div align="center">
        <table style="background-image: url(../igm/在线考试后台1.jpg); width: 992px; height: 621px">
            ...
            <tr>
                ...
                <td rowspan="2" style="vertical-align: top; width: 100px; text-align: center; he&nbsp";<asp:ScriptManager ID="ScriptManager1" runat="server">
                    </asp:ScriptManager>
                ...
                <td style="vertical-align: top; width: 100px; height: 494px; text-align: center">
                </td>
            </tr>
            </table>
